...
namespace HtmlAgilityPack
{
    ...
    public partial class HtmlNode
    {
        ...
        /// <summary>
        /// Gets or sets the value of the 'id' HTML attribute. The document must have been parsed
        /// using the OptionUseIdAttribute set to true.
        /// </summary>
        public string Id
        {
            get
        ...
        public virtual string InnerText
        {
            get
            {
                ...
                // note: right now, this method is *slow*, because we recompute everything. it could
                // be optimized like innerhtml
                if (!HasChildNodes)
                    return string.Empty;
        ...
        public string Name
        {
            ...
            set
            {
                _name = value; _optimizedName = null;
            }
        }
        ...
        /// <param name="deep">
        /// true to recursively clone the subtree under the specified node; false to clone only the
        /// node itself.
        /// </param>
        /// <returns>The cloned node.</returns>
        ...
        /// <summary>
        /// Helper method to get the value of an attribute of this node. If the attribute is not
        ...
        /// <summary>
        /// Helper method to set the value of an attribute of this node. If the attribute is not
        /// found, it will be created automatically.
        /// </summary>
            ...
            switch (_nodetype)
            {
                ...
                case HtmlNodeType.Element:
                    ...
                    if (HasChildNodes)
                    {
                        ...
                        {
                            // this code and the following tries to output things as nicely as
                            // possible for old browsers.
                            cdata = true;
                            outText.Write("\r\n//<![CDATA[\r\n");
                        }
        ...
        public void WriteTo(XmlWriter writer)
        {
            switch (_nodetype)
            {
                ...
                case HtmlNodeType.Element:
                    ...
                    {
                        if (attribute.Name.StartsWith("xmlns", StringComparison.InvariantCultureIgnoreCase))
                        {
